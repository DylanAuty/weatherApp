# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-03-22 01:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon_tf_day', models.CharField(max_length=20)),
                ('icon_tf_night', models.CharField(max_length=20)),
                ('icon_sf', models.CharField(max_length=20)),
                ('icon_tf_day_url', models.URLField()),
                ('icon_tf_night_url', models.URLField()),
                ('icon_sf_url', models.URLField()),
                ('fcttext_metric_day', models.CharField(max_length=200)),
                ('fcttext_metric_night', models.CharField(max_length=200)),
                ('pop', models.IntegerField()),
                ('pop_tf_day', models.IntegerField()),
                ('pop_tf_night', models.IntegerField()),
